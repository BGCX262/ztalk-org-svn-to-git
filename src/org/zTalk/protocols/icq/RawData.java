...
import org.zTalk.protocols.icq.exceptions.RawDataBadForcedLenghtException;
...
public class RawData extends DataField {
	...
	/**
	 * Construct a RawData containing a numeric value, but affect that value
	 * into the specified type of variable [byte, Word, DWord].
	 * 
	 * @param value
	 *            The RawData's numeric value.
	 * @param forcedLenght
