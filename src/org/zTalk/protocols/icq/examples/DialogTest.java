 ...
 * режиме: один экземпляр посылает другому сообщение, в ответ на которое тот
 * отвечает.
 * 
 * <p>
 * Created by 14.01.2010
 * 
...
public class DialogTest implements MessagingListener, OurStatusListener {
	...
	public DialogTest(String uin, String password, String recepient,
			boolean start) {
	...
	public static void main(String[] args) {
		if (args.length < 4) {
			System.out
					.println("Use : DialogTest UIN1 PASSWORD1 UIN2 PASSWORD2");
		} else {
