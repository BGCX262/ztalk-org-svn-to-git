 ...
 */
package org.zTalk.protocols.icq.packet.received.byddylist;
...
import org.zTalk.protocols.icq.setting.Capabilities;
import org.zTalk.protocols.icq.setting.enumerations.ClientsEnum;
...
public class IncomingUser__3_11 extends ReceivedPacket {
	...
	public void notifyEvent(OscarConnection connection) {
		...
		for (int i = 0; i < connection.getUserStatusListeners().size(); i++) {
			UserStatusListener l = (UserStatusListener) connection
					.getUserStatusListeners().get(i);
