...
import org.zTalk.protocols.icq.setting.enumerations.MessageMissedTypeEnum;
...
public class MissedMessage__4_10 extends ReceivedPacket {
	...
	public MissedMessage__4_10(byte[] array) {
		...
		do {
			...
			missedMsgCount = new RawData(data, index, RawData.WORD_LENGHT)
					.getValue();
			index += RawData.WORD_LENGHT;

			reason = new MessageMissedTypeEnum(new RawData(data, index,
					RawData.WORD_LENGHT).getValue());
			index += RawData.WORD_LENGHT;
