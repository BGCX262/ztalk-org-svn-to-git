 ...
 */
package org.zTalk.protocols.icq.packet.received.meta;
...
import org.zTalk.protocols.icq.metainfo.IMetaInfoParser;
import org.zTalk.protocols.icq.metainfo.MetaInfoParserFactory;
import org.zTalk.protocols.icq.packet.received.ReceivedPacket;
import org.zTalk.protocols.icq.setting.enumerations.MetaTypeEnum;
...
public class ServerMetaReply__21_3 extends ReceivedPacket {
	...
	public ServerMetaReply__21_3(byte[] array) throws ConvertStringException {
		...
		if (metaType == MetaTypeEnum.SERVER_ADVANCED_META) {
			RawData metaSubTypeRD = new RawData(data, position,
					RawData.WORD_LENGHT);
		...
		// Build parser
		metaInfoParser = MetaInfoParserFactory.buildMetaInfoParser(metaType,
				metaSubType);
