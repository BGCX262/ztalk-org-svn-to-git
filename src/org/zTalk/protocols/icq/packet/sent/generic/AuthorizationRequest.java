...
public class AuthorizationRequest extends Flap {
	 ...
	 *            The password.
	 * @param clientProfile
	 *            A string that could identify your client.
	 * @param majorVersion
	 *            Major version of your client.
	 * @param minorVersion
	 *            Minor version of your client.
	 * @param lesserVersion
	 *            Lesser version of your client.
	 * @param buildNumber
	 *            Build number of your client.
	 * @param language
	 *            A 2 characters String that identify your language.
	 * @param country
	 *            A 2 characters String that identify your country.
	 */
	public AuthorizationRequest(String Uin, String password,
