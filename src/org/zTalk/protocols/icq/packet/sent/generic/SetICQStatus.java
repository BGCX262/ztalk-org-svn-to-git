 ...
 */
package org.zTalk.protocols.icq.packet.sent.generic;
...
import org.zTalk.protocols.icq.setting.enumerations.StatusFlagEnum;
import org.zTalk.protocols.icq.setting.enumerations.StatusModeEnum;
import org.zTalk.protocols.icq.setting.enumerations.TcpConnectionFlagEnum;
...
public class SetICQStatus extends Flap {
	...
	private static final byte[] unknownFields = new byte[] { 0x00, 0x0B, 0x00,
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x50, 0x00, 0x00, 0x00, 0x03,
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			0x00, 0x00, 0x00 };

	public SetICQStatus(StatusModeEnum statusMode, StatusFlagEnum statusFlag,
			TcpConnectionFlagEnum tcpConnectionFlag, byte[] localIP, int p2pPort) {
		...
		snac.addRawDataToSnac(new RawData(tcpConnectionFlag
				.getTcpConnectionFlag(), RawData.BYTE_LENGHT));
