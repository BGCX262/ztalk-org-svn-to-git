...
public class MessageType2Ack extends Flap {
	...
	private static final byte[] unknown12 = { 0x00, 0x00, 0x00, 0x00, 0x00,
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };

	private static final byte[] msgTypeFooter = { 0x00, 0x00, 0x00, 0x00,
			(byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0x00 };

	public MessageType2Ack(RawData Time, RawData msgID, String UIN,
			RawData senderTcpVer, RawData msgSeqNum, RawData msgType,
			RawData msgFlags, String requestedMessage) {
