 ...
 */
package org.zTalk.protocols.icq.packet.sent.icbm;
...
public class SendXStatus extends Flap {
	...
	private static final byte[] CAPABILITY = { 0x00, 0x00, 0x00, 0x00, 0x00,
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };

	private static final byte[] CAPABILITY2 = { 0x1A, 0x00, 0x00, 0x00, 0x01,
			0x00, 0x01, 0x00, 0x00, 0x4F, 0x00, 0x3B, 0x60, (byte) 0xB3,
			(byte) 0xEF, (byte) 0xD8 };

	private static final byte[] CAPABILITY3 = { 0x2A, 0x6C, 0x45, (byte) 0xA4,
			(byte) 0xE0, (byte) 0x9C, 0x5A, 0x5E, 0x67, (byte) 0xE8, 0x65,
			0x08, 0x00, 0x2A, 0x00, 0x00 };

	private static final byte[] UNKNOWN = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };

	public SendXStatus(int Time, int msgID, String userId, String myId,
			int senderTcpVersion, XStatusModeEnum xstatus, String msg,
			String extmsg) throws ConvertStringException {
		super(2);
		...
		// Plugin information
		snac.addRawDataToSnac(new RawData(
		...
		// XStatus msg body
		snac.addRawDataToSnac(new RawData(
				"<NR><RES>&lt;ret event='OnRemoteNotification'&gt;&lt;srv&gt;&lt;id&gt;cAwaySrv&lt;/id&gt;&lt;val srv_id='cAwaySrv'&gt;&lt;Root&gt;&lt;CASXtraSetAwayMessage&gt;&lt;/CASXtraSetAwayMessage&gt;&lt;uin&gt;"
						+ myId
						+ "&lt;/uin&gt;&lt;index&gt;"
						+ xstatus.getXStatus() + "&lt;/index&gt;&lt;title&gt;"));
