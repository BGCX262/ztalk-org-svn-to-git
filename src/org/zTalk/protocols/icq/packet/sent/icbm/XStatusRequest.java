...
import org.zTalk.protocols.icq.setting.enumerations.MessageChannelEnum;
...
public class XStatusRequest extends SendMessage {
	...
	private static final byte[] CAPABILITY1 = { 0x09, 0x46, 0x13, 0x49, 0x4C,
			0x7F, 0x11, (byte) 0xD1, (byte) 0x82, 0x22, 0x44, 0x45, 0x53, 0x54,
			0x00, 0x00 };

	private static final byte[] CAPABILITY2 = { 0x00, 0x00, 0x00, 0x00, 0x00,
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };

	private static final byte[] CAPABILITY3 = { 0x1A, 0x00, 0x00, 0x00, 0x01,
			0x00, 0x01, 0x00, 0x00, 0x4F, 0x00, 0x3B, 0x60, (byte) 0xB3,
			(byte) 0xEF, (byte) 0xD8 };

	private static final byte[] CAPABILITY4 = { 0x2A, 0x6C, 0x45, (byte) 0xA4,
	...
	public XStatusRequest(String userId, String myId) {
		...
		super(userId, new MessageChannelEnum(
				MessageChannelEnum.MESSAGE_CHANNEL_2));
		...
		// Plugin information
		tlv2711.appendRawDataToTlv(new RawData(
		...
		tlv2711.appendRawDataToTlv(new RawData(
				"<N><QUERY>&lt;Q&gt;&lt;PluginID&gt;srvMng&lt;/PluginID&gt;&lt;/Q&gt;</QUERY><NOTIFY>&lt;srv&gt;&lt;id&gt;cAwaySrv&lt;/id&gt;&lt;req&gt;&lt;id&gt;AwayStat&lt;/id&gt;&lt;trans&gt;"
						+ trans
						+ "&lt;/trans&gt;&lt;senderId&gt;"
						+ myId
						+ "&lt;/senderId&gt;&lt;/req&gt;&lt;/srv&gt;</NOTIFY></N>"));
