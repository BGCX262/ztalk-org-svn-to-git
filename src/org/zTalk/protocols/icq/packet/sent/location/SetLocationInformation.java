 ...
 */
package org.zTalk.protocols.icq.packet.sent.location;
...
public class SetLocationInformation extends Flap {
	...
	private static final byte[] AIM_RECIVE_FROM_ICQ = { 0x09, 0x46, 0x13, 0x4D,
			0x4C, 0x7F, 0x11, (byte) 0xD1, (byte) 0x82, 0x22, 0x44, 0x45, 0x53,
			0x54, 0x00, 0x00 };
	...
	private static final byte[] ROUTE_FINDER_CAPS = { 0x09, 0x46, 0x13, 0x44,
			0x4C, 0x7F, 0x11, (byte) 0xD1, (byte) 0x82, 0x22, 0x44, 0x45, 0x53,
			0x54, 0x00, 0x00 };

	private static final byte[] ICQ_XTRAZ_CAPS = { (byte) 0x1A, 0x09, 0x3C,
			0x6C, (byte) 0xD7, (byte) 0xFD, 0x4E, (byte) 0xC5, (byte) 0x9D,
			0x51, (byte) 0xA6, 0x47, 0x4E, 0x34, (byte) 0xF5, (byte) 0xA0 };
