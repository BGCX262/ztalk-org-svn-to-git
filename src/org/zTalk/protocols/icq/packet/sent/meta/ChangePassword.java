 ...
 */
package org.zTalk.protocols.icq.packet.sent.meta;

import org.zTalk.protocols.icq.RawData;
import org.zTalk.protocols.icq.exceptions.ConvertStringException;
import org.zTalk.protocols.icq.setting.enumerations.MetaSubTypeEnum;
...
public class ChangePassword extends BaseClientMeta {
	...
	public ChangePassword(String uinForRequest, String password)
		...
		super(REQUEST_LENGHT
				+ (StringTools.stringToByteArray(password).length << 8),
				uinForRequest, MetaTypeEnum.CLIENT_ADVANCED_META,
				MetaSubTypeEnum.CHANGE_USER_PASSWORD);
