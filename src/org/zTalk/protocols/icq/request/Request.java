...
public class Request {
	...
	/**
	 * Construct a request that contains the Flap we want to monitor and a
	 * listener to warn when an answer to the request is received.
	 * 
	 * @param packet
	 *            The packet we're goint to monitor.
	 * @param listener
	 *            The listener to warn.
	 */
	 ...
	 * 
	 * @param listener
	 *            The listener whose presence is to be tested.
	 * 
	 ...
	 * 
	 * @param listener
	 *            The RequestListener to be added.
	 */
	 ...
	 * 
	 * @param listener
	 *            The RequestListener to be removed.
	 */
	 ...
	 * 
	 * @param index
	 *            Index of the RequestListener to return.
