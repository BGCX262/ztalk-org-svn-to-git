 ...
 */
package org.zTalk.protocols.icq.request.event;
...
public class RequestAnswerEvent extends EventObject {
	...
	/**
	 * Create a RequestAnswerEvent by defining the requesting packet and the
	 * reply packet that has been received.
	 * 
	 * @param requestPacket
	 *            The requesting packet.
	 * @param requestAnswerPacket
	 *            The reply packet.
	 */
