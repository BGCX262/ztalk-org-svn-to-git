 ...
 */
package org.zTalk.protocols.icq.setting;
...
public class Tweaker {
	...
	public Tweaker() {
		...
		map.put(INITIAL_STATUS_FLAGS, new StatusFlagEnum(
				StatusFlagEnum.DIRECT_CONNECTION_AUTHORIZATION, false, false,
				false));
		map.put(TCP_CONNECTION_FLAG, new TcpConnectionFlagEnum(
				TcpConnectionFlagEnum.NORMAL));
