...
public class GlobalErrorsEnum {
	...
	static {
		...
		allerrors.put(USER_TEMP_UNAVAIL,
		...
		allerrors.put(REQUEST_AMBIGOUS,
		...
		allerrors.put(REMOTE_RESTRICTED_BY_PC,
	...
	public String toString() {
		if (allerrors.containsKey(getCode()))
			return (String) allerrors.get(getCode());
		else
			return "";
	}
}
