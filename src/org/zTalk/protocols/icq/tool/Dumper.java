 ...
 */
package org.zTalk.protocols.icq.tool;
...
public class Dumper {
	...
	/**
	 * This methods dumps an imcoming packet represented with a byte array to a
	 * more "readable" String version.
	 * 
	 * @param packet
	 *            The received packet to be dumped.
	 * @param stringTranslation
	 *            Indicates if the byte must be converted to String.
	 ...
	 *            Indicates if the byte must be converted to String.
	 * @param spacer
	 *            Indicates the number of characters to write before adding a
	 *            space character.
	 * @param breaker
	 *            Indicates the number of characters to write before adding a
	 *            line break.
	...
	public static String dump(byte[] packet, boolean stringTranslation,
			...
			if (i % spacer == 0) {
				...
				if (i % breaker == 0) {
					if (stringTranslation) {
						System.arraycopy(packet, i - breaker, hexaChar, 0,
								breaker);
		...
		if (stringTranslation) {
			...
			System.arraycopy(packet, i - (i % breaker), lastLine, 0, i
					% breaker);
	 ...
	 * 
	 * @param b
	 *            The byte we want to convert into String.
	...
	/**
	 * This method filters all non-displayable characters and replace them with
	 * a '.' in the resulting String.
	 * 
	 * @param array
	 *            The receive byte array.
	...
	/**
	 * This method align the outputed String. This Method hides a buggy dump
	 * method. Anyone can seen the bug ?
	 * 
	 * @param wrote
	 *            The number of characters that have been wrote.
	 * @param expected
	 *            The number of characters that should have been wrote.
	 * 
